...
def get_seed_data():
    ...
    # ---- K线预测 P1: 下周涨跌预测 ----
    for i, q in enumerate([
        ('p1_q1', 'P1', 'text', '贵州茅台本周连续放量上涨突破MA20，MACD金叉，请预测下周方向？', None,
         '[{"label":"📈 看涨","value":"A"},{"label":"📉 看跌","value":"B"},{"label":"➡️ 横盘","value":"C"}]',
         'A', '放量上涨+突破MA20+MACD金叉，多头信号明确，下周大概率延续上涨。'),
        ('p1_q2', 'P1', 'text', '宁德时代本周缩量下跌跌破MA5和MA10，RSI持续走低，请预测下周方向？', None,
         '[{"label":"📈 看涨","value":"A"},{"label":"📉 看跌","value":"B"},{"label":"➡️ 横盘","value":"C"}]',
         'B', '缩量跌破短期均线+RSI走低，空头占优，下周可能继续回调。'),
        ('p1_q3', 'P1', 'text', '中国平安本周窄幅震荡成交量萎缩，布林带收窄，请预测下周方向？', None,
         '[{"label":"📈 看涨","value":"A"},{"label":"📉 看跌","value":"B"},{"label":"➡️ 横盘","value":"C"}]',
         'C', '窄幅震荡+量缩+布林带收窄，多空均衡，下周大概率继续横盘等待方向选择。'),
        ('p1_q4', 'P1', 'text', '比亚迪本周出现早晨之星，放量突破前期平台，请预测下周方向？', None,
         '[{"label":"📈 看涨","value":"A"},{"label":"📉 看跌","value":"B"},{"label":"➡️ 横盘","value":"C"}]',
         'A', '早晨之星+放量突破平台，多头确立，下周有望延续涨势。'),
        ('p1_q5', 'P1', 'text', '隆基绿能本周高位出现黄昏之星，大阴线跌破MA20，请预测下周方向？', None,
         '[{"label":"📈 看涨","value":"A"},{"label":"📉 看跌","value":"B"},{"label":"➡️ 横盘","value":"C"}]',
         'B', '黄昏之星+跌破MA20，空头信号明确，下周可能加速下跌。'),
        ('p1_q6', 'P1', 'text', '某股票本周放量站上布林带上轨，RSI超过80进入超买区，请预测下周方向？', None,
         '[{"label":"📈 看涨","value":"A"},{"label":"📉 看跌或回调","value":"B"},{"label":"➡️ 横盘","value":"C"}]',
         'B', '突破布林上轨+RSI超买，短期过热，下周大概率回调或横盘消化。'),
        ('p1_q7', 'P1', 'text', '某股票在底部横盘震荡3周后出现放量小阳线突破MA60，请预测下周方向？', None,
         '[{"label":"📈 看涨","value":"A"},{"label":"📉 看跌","value":"B"},{"label":"➡️ 横盘","value":"C"}]',
         'A', '底部横盘后放量突破MA60，是长期筑底结束信号，下周有望启动上涨。'),
        ('p1_q8', 'P1', 'text', '某股票本周连续十字星震荡，成交量极度萎缩，请预测下周方向？', None,
    ...
    # ---- K线预测 P2: 趋势转折预测 ----
    for i, q in enumerate([
        ('p2_q1', 'P2', 'text', '高位出现黄昏之星+量价背离+RSI超买回落，趋势是否即将反转？', None,
         '[{"label":"是，由涨转跌","value":"A"},{"label":"是，由跌转涨","value":"B"},{"label":"否，趋势延续","value":"C"}]',
         'A', '多重顶部信号叠加，趋势很可能由涨转跌。'),
        ('p2_q2', 'P2', 'text', '底部出现早晨之星+放量突破下降趋势线+MACD底背离，趋势是否即将反转？', None,
         '[{"label":"是，由涨转跌","value":"A"},{"label":"是，由跌转涨","value":"B"},{"label":"否，趋势延续","value":"C"}]',
         'B', '多重底部信号叠加，趋势很可能由跌转涨。'),
        ('p2_q3', 'P2', 'text', '小幅回调未破关键支撑，MA排列仍为多头，量能良好，趋势是否即将反转？', None,
         '[{"label":"是，由涨转跌","value":"A"},{"label":"是，由跌转涨","value":"B"},{"label":"否，趋势将延续","value":"C"}]',
         'C', '未破关键支撑+多头排列+量能配合，趋势大概率延续而非反转。'),
        ('p2_q4', 'P2', 'text', '上涨末端长上影线+量价背离+CCI超买拐头，趋势是否即将反转？', None,
         '[{"label":"是，由涨转跌","value":"A"},{"label":"是，由跌转涨","value":"B"},{"label":"否，趋势延续","value":"C"}]',
         'A', '长上影+量价背离+超买拐头，多头动能衰竭，可能由涨转跌。'),
        ('p2_q5', 'P2', 'text', '十字星震荡但重心仍在MA20之上，量能温和放大，趋势是否即将反转？', None,
         '[{"label":"是，由涨转跌","value":"A"},{"label":"是，由跌转涨","value":"B"},{"label":"否，趋势将延续","value":"C"}]',
         'C', '重心在MA20之上+量能放大，未出现明确反转信号。'),
        ('p2_q6', 'P2', 'text', '下跌趋势中出现放量锤子线+RSI底背离，趋势是否即将反转？', None,
         '[{"label":"是，由涨转跌","value":"A"},{"label":"是，由跌转涨","value":"B"},{"label":"否，趋势延续","value":"C"}]',
         'B', '锤子线+RSI底背离，底部买盘介入信号，趋势可能由跌转涨。'),
        ('p2_q7', 'P2', 'text', '上升趋势中MACD出现顶背离（价格创新高但MACD未创新高），趋势是否即将反转？', None,
         '[{"label":"是，由涨转跌","value":"A"},{"label":"是，由跌转涨","value":"B"},{"label":"否，趋势延续","value":"C"}]',
         'A', 'MACD顶背离说明价格上涨但动能在衰减，是潜在的顶部反转信号。'),
        ('p2_q8', 'P2', 'text', '布林带从上轨收窄转向水平，价格在中轨附近反复震荡，趋势是否即将反转？', None,
